...
function uploadFile(auth) {
   ...
   */
  let pathInternalOriginFolder = path.join(__dirname + `/auto_backup_db/${fileName}`)
  let pathInternalZipFile      = path.join(__dirname + `/auto_backup_db/${fileName}.zip`)
  zipdir(pathInternalOriginFolder, { saveTo: pathInternalZipFile }, (err, buffer) => {
      if (err) {
