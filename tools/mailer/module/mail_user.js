...
exports.sendMailForgetPassword = function (email, fullName, codeReset){
    ...
    mailer(email, `CODE XÁC NHẬN MẬT KHẨU/CONFIRM PASSWORD - TRIXGO.COM`, emailContent, function(cb){
        console.log(cb);
...
exports.sendMailNewAccount = function (email, fullName, pwd){
    ...
    mailer(email, `MẬT KHẨU MỚI/NEW PASSWORD - TRIXGO.COM`, emailContent, function(cb){
        console.log(cb);
    })
}
...
exports.sendMailTestWithAttachments = function (email, fullName){
    ...
    mailer(email, `EXAMPLE SEND MAIL WITH ATTACHMENTS - TRIXGO.COM`, emailContent, function(cb){
        console.log(cb);
    })
}