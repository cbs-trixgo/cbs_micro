// let USER_COLL         = require('../packages/permissions/users/databases/user-coll')({});
...
//                         .then(resultSendMessage => {
//                             console.log({ notiCloudMessaging: resultSendMessage })
//                             process.exit(0, () => console.log(`SIGTERM exit`))
//                         })
