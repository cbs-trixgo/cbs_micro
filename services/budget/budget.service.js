...
module.exports = {
    ...
    actions: {
        ...
        [CF_ACTIONS_BUDGET.BUDGET_GET_INFO_AND_GET_LIST]:
            BUDGET__HANDLER.getInfoAndGetList,
        [CF_ACTIONS_BUDGET.BUDGET_UPDATE_VALUE]: BUDGET__HANDLER.updateValue,
        [CF_ACTIONS_BUDGET.BUDGET_DOWNLOAD_TEMPLATE_EXCEL]:
            BUDGET__HANDLER.downloadTemplateExcel,
        ...
        [CF_ACTIONS_BUDGET.BUDGET_ITEM_GET_INFO_AND_GET_LIST]:
            BUDGET__ITEM_HANDLER.getInfoAndGetList,
        [CF_ACTIONS_BUDGET.BUDGET_ITEM_UPDATE_VALUE]:
            BUDGET__ITEM_HANDLER.updateValue,
        ...
        [CF_ACTIONS_BUDGET.BUDGET_GROUP_GET_INFO_AND_GET_LIST]:
            BUDGET__GROUP_HANDLER.getInfoAndGetList,
        [CF_ACTIONS_BUDGET.BUDGET_GROUP_UPDATE_VALUE]:
            BUDGET__GROUP_HANDLER.updateValue,
        ...
        [CF_ACTIONS_BUDGET.BUDGET_WORK_GET_INFO_AND_GET_LIST]:
            BUDGET__WORK_HANDLER.getInfoAndGetList,
        [CF_ACTIONS_BUDGET.BUDGET_WORK_UPDATE_VALUE]:
            BUDGET__WORK_HANDLER.updateValue,
        [CF_ACTIONS_BUDGET.BUDGET_WORK_DOWNLOAD_TEMPLATE_EXCEL]:
            BUDGET__WORK_HANDLER.downloadTemplateExcel,
        [CF_ACTIONS_BUDGET.BUDGET_WORK_IMPORT_EXCEL]:
            BUDGET__WORK_HANDLER.importExcel,
        [CF_ACTIONS_BUDGET.BUDGET_WORK_EXPORT_EXCEL]:
            BUDGET__WORK_HANDLER.exportExcel,
        [CF_ACTIONS_BUDGET.BUDGET_WORK_COPY]: BUDGET__WORK_HANDLER.copy,

        //==========================================   BUDGET_SUBMITTAL   ================================//
        [CF_ACTIONS_BUDGET.BUDGET_SUBMITTAL_INSERT]:
            BUDGET__SUBMITTAL_HANDLER.insert,
        [CF_ACTIONS_BUDGET.BUDGET_SUBMITTAL_UPDATE]:
            BUDGET__SUBMITTAL_HANDLER.update,
        [CF_ACTIONS_BUDGET.BUDGET_SUBMITTAL_REMOVE]:
            BUDGET__SUBMITTAL_HANDLER.remove,
        [CF_ACTIONS_BUDGET.BUDGET_SUBMITTAL_GET_INFO_AND_GET_LIST]:
            BUDGET__SUBMITTAL_HANDLER.getInfoAndGetList,
        [CF_ACTIONS_BUDGET.BUDGET_SUBMITTAL_GET_LIST_BY_PROPERTY]:
            BUDGET__SUBMITTAL_HANDLER.getListByProperty,
    },
