        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_CUSTOMER_CARE_MODEL.insert({
                        userID,
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_CUSTOMER_CARE_MODEL.update({
                        companyID: company._id,
                        userID,
                        customerCareID,
                        customerID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_CUSTOMER_CARE_MODEL.remove({
                        orderMistakeID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (orderMistakeID) {
                    resultAfterCallHandler =
                        await FNB_CUSTOMER_CARE_MODEL.getInfo({
                            orderMistakeID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await FNB_CUSTOMER_CARE_MODEL.getList({
                            option,
                            companyID,
                            fundasID,
                            businessID,
