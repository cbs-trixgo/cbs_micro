 ...
 */
  ...
  * MODELS
  */
 const FNB_ZALOOA_MODEL            = require('../model/fnb.zalooa-model').MODEL;
     ...
     insert: {
         ...
         async handler(ctx) {
             try {
                ...
                let resultAfterCallHandler = await FNB_ZALOOA_MODEL.insert({
     ...
     update: {
         ...
         async handler(ctx) {
             try {
                 ...
                 let resultAfterCallHandler = await FNB_ZALOOA_MODEL.update({
     ...
     remove: {
         ...
         async handler(ctx) {
             try {
                 ...
                 let resultAfterCallHandler = await FNB_ZALOOA_MODEL.remove({
                    productID
                 });
     ...
     getInfoAndGetList: {
         ...
         async handler(ctx) {
             try {
                 ...
                 if(productID){
                     resultAfterCallHandler = await FNB_ZALOOA_MODEL.getInfo({
                        productID, select, populates,
                     });
                 }else{
                     resultAfterCallHandler = await FNB_ZALOOA_MODEL.getList({
    ...
    downloadTemplateExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                // console.log('====================HERE===================')
                // console.log('====================HERE===================')
                const resultAfterCallHandler = await FNB_ZALOOA_MODEL.downloadTemplateExcel({
    ...
    importFromExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await FNB_ZALOOA_MODEL.importFromExcel({
    ...
    exportExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await FNB_ZALOOA_MODEL.exportExcel({
