 ...
 * MODELS
 */
const FNB_CUSTOMER_BOOKING_MODEL =
    require('../model/fnb.customer_booking-model').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.insert({
                        userID,
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.update({
                        userID,
                        customerCareID,
                        customerID,
                        orderID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.remove({
                        orderMistakeID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (orderMistakeID) {
                    resultAfterCallHandler =
                        await FNB_CUSTOMER_BOOKING_MODEL.getInfo({
                            orderMistakeID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await FNB_CUSTOMER_BOOKING_MODEL.getList({
                            companyID,
                            userID,
                            fundasID,
                            customerID,
    ...
    getListByProperty: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.getListByProperty({
                        option,
                        optionGroup,
                        companyID: company._id,
                        optionTime,
    ...
    downloadTemplateExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.downloadTemplateExcel({
                        companyID: company._id,
                        userID,
                    })
    ...
    importFromExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.importFromExcel({
                        taskID,
                        dataImport,
                        userID,
                        ctx,
    ...
    exportExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_CUSTOMER_BOOKING_MODEL.exportExcel({
                        userID,
                        companyID,
                        fundaID,
                        fromDate,
