 ...
 * MODELS
 */
const FNB_ORDER_PRODUCT_MODEL =
    require('../model/fnb.order_product-model.js').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.insert({
                        orderID,
                        productID,
                        size,
                        sugar,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.update({
                        orderID,
                        userID,
                        mistakeID,
                        customerID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.remove({
                        orderID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.getList({
                        companyID,
                        fundaID,
                        orderID,
                        fromDate,
    ...
    getListByProperty: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.getListByProperty({
                        option,
                        optionGroup,
                        optionTime,
                        fundasID,
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.downloadTemplateExcel({
    ...
    importFromExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.importFromExcel({
                        taskID,
                        dataImport,
                        userID,
                        ctx,
    ...
    exportExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FNB_ORDER_PRODUCT_MODEL.exportExcel2({
                        userID,
                        email,
                        companyID,
                        option,
