...
module.exports = {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.insert({
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.update({
                        cashBookID,
                        accountID,
                        customerID,
                        contractID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.remove({
                        cashBooksID,
                        userID,
                    })
    ...
    getAmountIncomeAndExpenseByParent: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.getAmountIncomeAndExpenseByParent(
                        {
                            parentID,
                        }
                    )
    ...
    getAmountByProperty: {
        ...
        async handler(ctx) {
            try {
                await this.validateEntity(ctx.params)
                let { companyID, parentID, accountID, year, option } =
                    ctx.params
                ...
                let resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.getAmountByProperty({
                        userID,
                        companyID,
                        parentID,
                        accountID,
    ...
    downloadTemplateExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.downloadTemplateExcel({
                        companyID: company._id,
                        parentID,
                        userID,
                        option,
    ...
    importFromExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.importFromExcel({
                        companyID: company._id,
                        option,
                        parentID,
                        dataImport,
    ...
    exportExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_BOOK_MODEL.exportExcel({
                        userID,
                        companyID: company._id,
                        parentID,
                        userID,
