        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_FLOW_PLAN_MODEL.insert({
                        companyID,
                        fundaID,
                        contractID,
                        projectID,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FIN__CASH_FLOW_PLAN_MODEL.update({
                        cashFlowID,
                        contractID,
                        name,
                        openingBalance,
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FIN__CASH_FLOW_PLAN_MODEL.remove({
                        cashFlowsID,
                        userID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (cashFlowID) {
                    resultAfterCallHandler =
                        await FIN__CASH_FLOW_PLAN_MODEL.getInfo({
                            cashFlowID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await FIN__CASH_FLOW_PLAN_MODEL.getList({
                            companyID,
                            projectID,
                            contractID,
                            parentID,
