 ...
 * MODELS
 */
const CMCS__CONTRACT_PAYMENT_MODEL =
    require('../model/cmcs.contract_payment-model').MODEL
...
module.exports = {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.insert({
                        contractID,
                        ipc,
                        date,
                        name,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.update({
                        contractPaymentID,
                        ipc,
                        date,
                        name,
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.remove({
                        contractPaymentID,
                        userID,
                    })
        ...
        async handler(ctx) {
            try {
                ...
                if (contractPaymentID) {
                    resultAfterCallHandler =
                        await CMCS__CONTRACT_PAYMENT_MODEL.getInfo({
                            contractPaymentID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await CMCS__CONTRACT_PAYMENT_MODEL.getList({
                            contractID,
                            userID,
                            keyword,
                            limit,
    ...
    getListByMonth: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.getListByMonth({
                        userID,
                        companyID,
                        projectID,
                        contractID,
    ...
    getAmountByMonth: {
        ...
        async handler(ctx) {
            try {
                await this.validateEntity(ctx.params)
                let { companyID, projectID, contractID, year, outin, option } =
                    ctx.params
                ...
                let resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.getAmountByMonth({
                        userID,
                        companyID,
                        projectID,
                        contractID,
    ...
    getAmountByObject: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.getAmountByObject({
                        userID,
                        outin: Number(outin),
                        companyID,
                        projectID,
    ...
    getAmountByProperty: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await CMCS__CONTRACT_PAYMENT_MODEL.getAmountByProperty({
                        userID,
                        companyID,
                        projectID,
                        contractID,
