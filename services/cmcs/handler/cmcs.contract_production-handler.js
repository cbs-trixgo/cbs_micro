 ...
 * MODELS
 */
const CMCS__CONTRACT_PRODUCTION_MODEL =
  require('../model/cmcs.contract_production-model').MODEL
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.insert({
            contractID,
            name,
            sign,
            description,
  ...
  update: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.update({
            contractProductionID,
            name,
            sign,
            description,
  ...
  remove: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.remove({
            contractProductionID,
          })
    ...
    async handler(ctx) {
      try {
        ...
        if (contractProductionID) {
          resultAfterCallHandler =
            await CMCS__CONTRACT_PRODUCTION_MODEL.getInfo({
              contractProductionID,
              userID,
              select,
              populates,
          ...
          resultAfterCallHandler =
            await CMCS__CONTRACT_PRODUCTION_MODEL.getList({
              contractID,
              userID,
              keyword,
              limit,
  ...
  getListByMonth: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.getListByMonth({
            userID,
            companyID,
            projectID,
            contractID,
  ...
  getAmountByMonth: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.getAmountByMonth({
            userID,
            companyID,
            projectID,
            outin: Number(outin),
  ...
  getAmountByObject: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.getAmountByObject({
            userID,
            outin: Number(outin),
            companyID,
            projectID,
  ...
  getAmountByProperty: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CMCS__CONTRACT_PRODUCTION_MODEL.getAmountByProperty({
            userID,
            companyID,
            projectID,
            contractID,
