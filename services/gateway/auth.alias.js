...
const { CF_ROUTINGS_CHATTING } 		= require('../chatting/helper/chatting.routes-constant');
const { CF_ROUTINGS_DOCUMENT } 		= require('../document/helper/document.routes-constant');
const { CF_ROUTINGS_PAYMENT } 		= require('../payment/helper/payment.routes-constant');
const { CF_ROUTINGS_REMINDER } 		= require('../reminder/helper/reminder.routes-constant');
...
const { CF_ROUTINGS_TRAINING } 	    = require('../training/helper/training.routes-constant');
const { CF_ROUTINGS_SUBJECT_PCM }	= require('../subject_pcm/helper/subject_pcm.routes-constant');
const { CF_ROUTINGS_OPERATION }		= require('../operation/helper/operation.routes-constant');
const { CF_ROUTINGS_NOTIFICATION }	= require('../notification/helper/notification.routes-constant');
const { CF_ROUTINGS_REACTION }		= require('../reaction/helper/reaction.routes-constant');
const { CF_ROUTINGS_ANALYSIS }		= require('../analysis/helper/analysis.routes-constant');
const { CF_ROUTINGS_ACCOUNTING }	= require('../accounting/helper/accounting.routes-constant');
const { CF_ROUTINGS_TIMESHEET }		= require('../timesheet/helper/timesheet.routes-constant');
const { CF_ROUTINGS_PERSONAL }		= require('../personal/helper/personal.routes-constant');
const { CF_ROUTINGS_DATAHUB }		= require('../datahub/helper/datahub.routes-constant');
const { CF_ROUTINGS_BIDDING }		= require('../bidding/helper/bidding.routes-constant');
const { CF_ROUTINGS_FIN }			= require('../fin/helper/fin.routes-constant');
const { CF_ROUTINGS_BUDGET }		= require('../budget/helper/budget.routes-constant');
...
const { CF_ACTIONS_DOCUMENT } 		= require('../document/helper/document.actions-constant');
const { CF_ACTIONS_PAYMENT } 		= require('../payment/helper/payment.actions-constant');
...
const { CF_ACTIONS_TRAINING } 	    = require('../training/helper/training.actions-constant');
const { CF_ACTIONS_SUBJECT_PCM } 	= require('../subject_pcm/helper/subject_pcm.actions-constant');
const { CF_ACTIONS_OPERATION } 		= require('../operation/helper/operation.actions-constant');
const { CF_ACTIONS_NOTIFICATION }	= require('../notification/helper/notification.actions-constant');
const { CF_ACTIONS_REACTION }		= require('../reaction/helper/reaction.actions-constant');
...
const { CF_ACTIONS_TIMESHEET }		= require('../timesheet/helper/timesheet.actions-constant');
const { CF_ACTIONS_PERSONAL }		= require('../personal/helper/personal.actions-constant');
const { CF_ACTIONS_DATAHUB }		= require('../datahub/helper/datahub.actions-constant');
const { CF_ACTIONS_BIDDING }		= require('../bidding/helper/bidding.actions-constant');
