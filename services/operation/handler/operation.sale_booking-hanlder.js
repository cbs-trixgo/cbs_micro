 ...
 * MODELS
 */
const OPERATION__SALE_BOOKING_MODEL =
    require('../model/operation.sale_booking-model').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await OPERATION__SALE_BOOKING_MODEL.insert({
                        projectID,
                        name,
                        note,
                        departmentID,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await OPERATION__SALE_BOOKING_MODEL.update({
                        saleBookingID,
                        projectID,
                        name,
                        note,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await OPERATION__SALE_BOOKING_MODEL.remove({
                        saleBookingID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (saleBookingID) {
                    resultAfterCallHandler =
                        await OPERATION__SALE_BOOKING_MODEL.getInfo({
                            saleBookingID,
                        })
                } else {
                    resultAfterCallHandler =
                        await OPERATION__SALE_BOOKING_MODEL.getList({
                            projectID,
                            type,
                            status,
                            sale,
