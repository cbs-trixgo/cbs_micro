...
const TIMESHEET__EXPERT_SALARY_MODEL =
    require('../model/timesheet.expert_salary-model').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await TIMESHEET__EXPERT_SALARY_MODEL.insert({
                        userCreate: userID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await TIMESHEET__EXPERT_SALARY_MODEL.remove({
                        arraysRemove,
                        userID,
                    })
    ...
    syncData: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await TIMESHEET__EXPERT_SALARY_MODEL.syncData({
                        userID,
                        companyID: company._id,
                        option,
                        salaryID,
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (expertSalaryID) {
                    resultAfterCallHandler =
                        await TIMESHEET__EXPERT_SALARY_MODEL.getInfo({
                            expertSalaryID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await TIMESHEET__EXPERT_SALARY_MODEL.getList({
                            parentID,
                            companyID,
                            projectID,
                            userID,
    ...
    getListByProperty: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await TIMESHEET__EXPERT_SALARY_MODEL.getListByProperty({
                        option,
                        year,
                        companyID,
                        projectID,
