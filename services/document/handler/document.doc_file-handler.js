        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DOCUMENT__DOC_FILE_MODEL.insert({
                        documentID,
                        fileID,
                        userID,
                    })
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DOCUMENT__DOC_FILE_MODEL.update({
                        docFileID,
                        official,
                    })
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DOCUMENT__DOC_FILE_MODEL.delete({
                        docFileID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (docFileID) {
                    resultAfterCallHandler =
                        await DOCUMENT__DOC_FILE_MODEL.getInfo({
                            docFileID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await DOCUMENT__DOC_FILE_MODEL.getList({
                            documentID,
                            userID,
                            lastestID,
                            limit: +limit,
