        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await DOCUMENT__PACKAGE_MODEL.insert({
                        userID,
                        parentID,
                        fieldID,
                        projectID,
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DOCUMENT__PACKAGE_MODEL.update({
                        packageID,
                        userID,
                        ctx,
                        fieldID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DOCUMENT__PACKAGE_MODEL.remove({
                        packageID,
                    })
                return renderStatusCodeAndResponse({
                    resultAfterCallHandler,
    ...
    removeMany: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DOCUMENT__PACKAGE_MODEL.removeMany({
                        packagesID,
                    })
                return renderStatusCodeAndResponse({
                    resultAfterCallHandler,
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (packageID) {
                    resultAfterCallHandler =
                        await DOCUMENT__PACKAGE_MODEL.getInfo({
                            packageID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await DOCUMENT__PACKAGE_MODEL.getListPackage({
                            isShowAll,
                            departmentID,
                            parentID,
                            status,
