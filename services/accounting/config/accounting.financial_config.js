...
exports.APP_ROLES = [
  {
    value: 11,
    text: 'Nhóm quản trị ứng dụng',
    permission: { read: 1, create: 1, update: 1, deleteIn: 1 },
  },
  {
    value: 12,
    text: 'Nhóm ban lãnh đạo',
    permission: { read: 1, create: 1, update: 1, deleteIn: 0 },
  },
  {
    value: 13,
    text: 'Nhóm nhân viên công ty',
    permission: { read: 1, create: 1, update: 1, deleteIn: 0 },
  },
  {
    value: 14,
    text: 'Nhóm khách mời của công ty',
    permission: { read: 1, create: 0, update: 0, deleteIn: 0 },
  },
]
...
exports.PROJECT_ROLES = [
  {
    value: 21,
    text: 'Nhóm quản trị Dự án/Phòng ban/Hợp đồng',
    permission: { read: 1, create: 1, update: 1, deleteIn: 1 },
  },
  {
    value: 22,
  ...
  {
    value: 23,
    text: 'Nhóm thành viên Dự án/Phòng ban/Hợp đồng',
    permission: { read: 1, create: 1, update: 1, deleteIn: 0 },
  },
  {
    value: 24,
    text: 'Nhóm khách mời của Dự án/Phòng ban/Hợp đồng',
    permission: { read: 1, create: 0, update: 0, deleteIn: 0 },
  },
]
...
exports.CNC_PROJECT_ROLES = [
  ...
  {
    value: 23,
    text: 'Phòng Quản lý kỹ thuật',
    permission: { read: 1, create: 1, update: 1, deleteIn: 0 },
  },
  {
    value: 24,
    text: 'Phòng Tài chính đầu tư',
    permission: { read: 1, create: 1, update: 1, deleteIn: 0 },
  },
  {
    value: 25,
...
exports.DEPARTMENT_STATUS = [
  {
    ...
    class: 'tajic-status-btn-in-progress',
    backgroud: '00aaff',
    key: 'in_progress',
  },
  {
  ...
  },
  {
    value: 3,
    text: 'Hoàn thành',
    class: 'tajic-status-btn-completed',
    backgroud: '5fba7d',
    key: 'completed',
  },
  {
    value: 4,
    text: 'Tạm dừng',
    class: 'tajic-status-btn-follow-up',
    backgroud: '5bc0de',
    key: 'follow_up',
  },
]
...
exports.BUILDING_TYPES = [
  ...
  {
    value: 4,
    text: 'Công trình nông nghiệp và phát triển nông thôn',
    key: 'follow_up',
  },
...
exports.CRM_BIDDINGTYPE = [
  ...
  {
    value: 7,
    text: 'Lựa chọn nhà thầu, nhà đầu tư trong trường hợp đặc biệt',
    key: 'completed',
  },
...
exports.BIIDING_DOCUMENT = [
  {
    value: 1,
    text: 'Bảng dữ liệu gói thầu',
    key: 'no',
    conditions: [
      {
        value: 11,
        text: 'Số hiệu thư mời thầu',
      ...
      {
        value: 18,
        text: 'Phạm vi công việc gói thầu',
        field: 'scopeOfPackage',
        key: 'no',
        type: 'text',
      },
      {
        value: 19,
        text: 'Thời gian thực hiện hợp đồng (ngày)',
        field: 'duration',
        key: 'no',
        type: 'number',
      },
      ...
      {
        value: 111,
        text: 'Hồ sơ đính kèm (video, bản vẽ, spec,...)',
        field: 'documentIntroduction',
        key: 'no',
        attach: 'yes',
        type: 'text',
      },
      ...
      {
        value: 114,
        text: 'Cách thức tổ chức và chuẩn bị hồ sơ dự thầu',
        field: 'method',
        key: 'no',
        type: 'text',
      },
      {
        value: 115,
        text: 'Hiệu lực của hồ sơ dự thầu tới ngày',
        field: 'validity',
        key: 'no',
        type: 'date',
      },
      {
        value: 116,
        text: 'Giá trị đảm bảo dự thầu (hình thức đảm bảo bằng thư bảo lãnh của ngân hàng)',
        field: 'security',
        key: 'no',
        type: 'number',
      },
      {
        value: 117,
        text: 'Hiệu lực của đảm bảo dự thầu tới ngày',
        field: 'securityValidity',
        key: 'no',
        type: 'date',
      },
      {
        value: 118,
        text: 'Về việc làm rõ hồ sơ mời thầu',
        field: 'bidsClarification',
        key: 'no',
        type: 'text',
      },
      {
        value: 119,
        text: 'Về việc làm rõ hồ sơ dự thầu trong quá trình chấm thầu',
        field: 'documentsClarification',
        key: 'no',
        type: 'text',
      },
      {
        value: 120,
        text: 'Về việc đề xuất phương án thay thế',
        field: 'alternative',
        key: 'no',
        type: 'text',
      },
      ...
      {
        value: 122,
        text: 'Thời hạn nộp hồ sơ dự thầu',
        field: 'deadline',
        key: 'no',
        type: 'date',
      },
      {
        value: 123,
        text: 'Nguyên tắc lựa chọn nhà thầu của chủ đầu tư',
        field: 'evaluation',
        key: 'no',
        type: 'text',
      },
      {
        value: 124,
        text: 'Về việc thương thảo hợp đồng',
        field: 'negotiation',
        key: 'no',
        type: 'text',
      },
      {
        value: 125,
        text: 'Về cách thức tham dự thầu',
        field: 'biddingSolution',
        key: 'no',
        type: 'text',
      },
      {
        value: 126,
        text: 'Về chi phí tham dự thầu trả cho nền tảng Trixgo',
        field: 'biddingExpense',
        key: 'no',
        type: 'number',
      },
      {
        value: 127,
        text: 'Về thông tin/yêu cầu khác',
        field: 'biddingOther',
        key: 'no',
        type: 'text',
      },
  ...
  {
    value: 2,
    text: 'Yêu cầu về tư cách hợp lệ',
    key: 'no',
    conditions: [
      {
        value: 21,
        text: 'Ngành nghề kinh doanh hợp pháp và phù hợp với gói thầu theo quy định hiện hành',
        field: 'capacityBusiness',
        field2: 'capacityBusinessNotice',
        key: 'no',
        type: 'text',
      },
      {
        value: 22,
        text: 'Chứng chỉ năng lực hoạt động xây dựng phù hợp theo quy định hiện hành',
        field: 'capacityCertificate',
        field2: 'capacityCertificateNotice',
        key: 'no',
        type: 'text',
      },
      {
        value: 23,
        text: 'Hạch toán tài chính độc lập',
        field: 'capacityIndependentAccounting',
        field2: 'capacityIndependentAccountingNotice',
        key: 'no',
        type: 'text',
      },
      {
        value: 24,
        text: 'Đã đăng ký trên Hệ thống mạng đấu thầu quốc gia',
        field: 'capacityTNBNS',
        field2: 'capacityTNBNSNotice',
        key: 'no',
        type: 'text',
      },
      {
        value: 25,
        text: 'Tham dự thầu với tư cách là nhà thầu độc lập',
        field: 'capacityIndependentContractor',
        field2: 'capacityIndependentContractorNotice',
        key: 'no',
        type: 'text',
      },
      {
        value: 26,
        text: 'Tư cách hợp lệ khác',
        field: 'capacityOther',
        field2: 'capacityOtherNotice',
        key: 'no',
        type: 'text',
      },
  ...
  {
    value: 3,
    text: 'Yêu cầu về năng lực tài chính',
    key: 'no',
    conditions: [
      {
        value: 311,
      ...
      {
        value: 313,
        text: 'Giá trị lợi nhuận trong khoảng (từ->đến) phải lớn hơn',
      ...
      {
        value: 314,
        text: 'Giá trị tài sản ròng trong năm gần nhất phải lớn hơn',
        field: 'financialNetWorth',
        key: 'no',
        type: 'number',
      },
      {
        value: 315,
        text: 'Doanh thu bình quân hàng năm trong khoảng (từ->đến) từ hoạt động xây dựng phải lớn hơn',
        field: 'financialConstructionRevenue',
        key: 'no',
        type: 'number',
      },
      {
        value: 316,
        text: 'Xác nhận của cơ quan Thuế về việc Nhà thầu hoàn tất nghĩa vụ thuế/không còn nợ thuế',
        field: 'financialProof',
        key: 'no',
        type: 'text',
      },
    ],
  ...
  {
    value: 4,
    text: 'Yêu cầu về năng lực kinh nghiệm/Hợp đồng tương tự',
    key: 'no',
    conditions: [
      {
        value: 41,
        text: 'Tính chất tương tự',
      ...
      {
        value: 42,
        text: 'Số năm gần đây (tính từ năm hiện tại trở về trước)',
        field: 'contractRecently',
        key: 'no',
        type: 'number',
      },
      {
        value: 43,
        text: 'Số lượng hợp đồng tối thiểu',
      ...
      {
        value: 44,
        text: 'Giá trị tối thiểu của từng hợp đồng',
        field: 'contractMinValue',
        key: 'no',
        type: 'number',
      },
      {
        value: 45,
        text: 'Tổng giá trị tối thiểu của tất cả các hợp đồng',
        field: 'contractMinTotalValue',
        key: 'no',
        type: 'number',
      },
      {
  ...
  {
    value: 5,
    text: 'Yêu cầu về năng lực nhân sự',
    key: 'no',
    conditions: [
      {
        value: 51,
      ...
      {
        value: 54,
        text: 'Số năm kinh nghiệm trong các công việc tương tự',
        field: 'humanYoExpInTheSame',
        key: 'no',
        type: 'number',
      },
      {
        value: 55,
        text: 'Yêu cầu về số công trình tương tự đã thực hiện',
        field: 'humanProjectInTheSame',
        key: 'no',
        type: 'number',
      },
      {
        value: 56,
        text: 'Yêu cầu về trình độ chuyên môn',
        field: 'humanMajor',
        key: 'no',
        type: 'text',
      },
      {
        value: 57,
        text: 'Yêu cầu về văn bằng chứng chỉ',
        field: 'humanCertificate',
        key: 'no',
        type: 'text',
      },
      {
        value: 58,
        text: 'Yêu cầu về hợp đồng lao động và bảo hiểm',
        field: 'humanContract',
        key: 'no',
        type: 'text',
      },
      {
        value: 59,
        text: 'Yêu cầu về tính chất tương tự của các công trình đã thực hiện',
        field: 'humanExpHistory',
        key: 'no',
        type: 'text',
      },
    ],
  ...
  {
    value: 6,
    text: 'Yêu cầu về năng lực thiết bị',
    key: 'no',
    conditions: [
      {
        value: 61,
        text: 'Loại và đặc điểm thiết bị',
        field: 'machineType',
        key: 'no',
        type: 'text',
      },
      ...
      {
        value: 63,
        text: 'Hồ sơ thiết bị đi kèm',
        field: 'machineDocument',
        key: 'no',
        type: 'text',
      },
    ],
  ...
  {
    value: 7,
    text: 'Yêu cầu về giải pháp tổ chức thực hiện',
    key: 'no',
    conditions: [
      {
        value: 71,
      ...
      {
        value: 73,
        text: 'Điểm tối đa đạt được',
        field: 'methodMaxScore',
        key: 'no',
        type: 'number',
      },
      {
        value: 74,
        text: 'Điểm tối thiểu đạt được',
        field: 'methodMinScore',
        key: 'no',
        type: 'number',
      },
    ],
  ...
  {
    value: 9,
    text: 'Thông tin nhà thầu, Đơn dự thầu, bảo lãnh dự thầu và thông tin khác',
    key: 'no',
    conditions: [
      {
        value: 91,
...
exports.BIIDING_APPLY = [
  { value: 1, text: 'Bảng dữ liệu gói thầu', key: 'no', conditions: [] },
  { value: 2, text: 'Yêu cầu về tư cách hợp lệ', key: 'no', conditions: [] },
  {
    value: 3,
    text: '	Yêu cầu về năng lực tài chính',
    key: 'no',
    conditions: [
      ...
      {
        value: 39,
        text: 'Tổng doanh thu trong lĩnh vực xây dựng',
        field: 'grossConstructionRevenue',
        key: 'no',
        type: 'number',
      },
      {
  ...
  },
  {
    ...
    conditions: [
      ...
      {
        value: 52,
        text: 'Vị trí công việc đảm nhận',
        field: 'humanPosition',
        key: 'no',
        type: 'text',
      },
      ...
      {
        value: 56,
        text: 'Số năm kinh nghiệm trong lĩnh vực tương tự',
        field: 'humanYoExpInTheSame',
        key: 'no',
        type: 'number',
      },
      ...
      {
        value: 59,
        text: 'Hợp đồng lao động và bảo hiểm',
        field: 'humanContract',
        key: 'no',
        type: 'text',
      },
      {
        value: 510,
        text: 'Số công trình đã thực hiện tương tự',
        field: 'humanProjectInTheSame',
        key: 'no',
        type: 'number',
      },
  ...
  },
  {
    ...
    conditions: [
      ...
      },
      {
        value: 65,
        text: 'Năm sản xuất',
        field: 'machineYearOfManufacture',
        key: 'no',
        type: 'number',
      },
      {
      ...
      {
        value: 68,
        text: 'Địa điểm hiện tại của thiết bị',
        field: 'machineCurrentLocation',
        key: 'no',
        type: 'text',
      },
      {
        value: 69,
        text: 'Thông tin về tình hình huy động',
        field: 'machineMobilization',
        key: 'no',
        type: 'text',
      },
      {
  ...
  { value: 8, text: 'Điều khoản hợp đồng', key: 'no', conditions: [] },
  {
    value: 9,
    text: 'Thông tin nhà thầu, đơn dự thầu, bảo lãnh dự thầu và thông tin khác',
    key: 'no',
    conditions: [
      ...
      {
        value: 912,
        text: 'Nơi nhà thầu đăng ký kinh doanh, hoạt động',
        field: 'contractorPalace',
        key: 'no',
        type: 'text',
      },
      {
        value: 913,
        text: 'Năm thành lập công ty',
        field: 'contractorDate',
        key: 'no',
        type: 'Date',
      },
      {
        value: 914,
        text: 'Địa chỉ hợp pháp của nhà thầu',
      ...
      {
        value: 915,
        text: 'Tên đại diện hợp pháp của nhà thầu',
        field: 'contractorLegalRep',
        key: 'no',
        type: 'text',
      },
      {
        value: 916,
        text: 'Địa chỉ đại diện hợp pháp của nhà thầu',
        field: 'contractorRepAddress',
        key: 'no',
        type: 'text',
      },
      {
        value: 917,
        text: 'Số điện thoại/fax đại diện hợp pháp của nhà thầu',
        field: 'contractorRepPhone',
        key: 'no',
        type: 'text',
      },
      {
        value: 918,
        text: 'Địa chỉ email đại diện hợp pháp của nhà thầu',
        field: 'contractorRepEmail',
        key: 'no',
        type: 'text',
      },
      {
      ...
      {
        value: 92,
        text: 'Thời gian dự kiến thực hiện hợp đồng (ngày)',
        field: 'invitationLetterExc',
        key: 'no',
        type: 'number',
      },
      {
        value: 93,
        text: 'Số ngày có hiệu lực của hồ sơ dự thầu',
        field: 'invitationLetterDuration',
        key: 'no',
        type: 'number',
      },
      {
        value: 94,
        text: 'Ngày bắt đầu có hiệu lực của hồ sơ dự thầu',
        field: 'invitationLetterStart',
        key: 'no',
        type: 'date',
      },
      ...
      {
        value: 932,
        text: 'Ngày phát hành bảo lãnh dự thầu',
        field: 'tgDate',
        key: 'no',
        type: 'date',
      },
      ...
      {
        value: 9310,
        text: 'Số ngày có hiệu lực của bảo lãnh dự thầu',
        field: 'tgDuration',
        key: 'no',
        type: 'number',
      },
      {
        value: 9311,
        text: 'Ngày bắt đầu có hiệu lực của bảo lãnh dự thầu',
        field: 'tgEffectiveDate',
        key: 'no',
        type: 'date',
      },
...
exports.BIIDING_EVALUATION = [
  { value: 1, text: 'Bảng dữ liệu gói thầu', key: 'no', conditions: [] },
  {
    ...
    conditions: [
      ...
      {
        value: 22,
        text: 'Chứng chỉ năng lực hoạt động xây dựng',
        field: 'capacityCertificate',
        key: 'no',
        type: 'option',
      },
      ...
      },
      {
        value: 28,
        text: 'Chứng chỉ năng lực hoạt động xây dựng',
        field: 'capacityCertificateNotice',
        key: 'no',
        type: 'area',
      },
      {
        value: 29,
        text: 'Hạch toán tài chính độc lập',
        field: 'capacityIndependentAccountingNotice',
        key: 'no',
        type: 'area',
      },
      {
      ...
      },
      {
        value: 211,
        text: 'Tham dự thầu với tư cách là nhà thầu độc lập',
        field: 'capacityIndependentContractorNotice',
        key: 'no',
        type: 'area',
      },
      {
  ...
  },
  {
    ...
    conditions: [
      ...
      {
        value: 34,
        text: 'Giá trị tài sản ròng trong năm gần nhất',
        field: 'financialNetWorth',
        key: 'no',
        type: 'option',
      },
      {
        value: 35,
        text: 'Doanh thu bình quân hàng năm từ hoạt động xây dựng',
        field: 'financialConstructionRevenue',
        key: 'no',
        type: 'option',
      },
      ...
      },
      {
        value: 311,
        text: 'Doanh thu bình quân hàng năm từ hoạt động xây dựng',
        field: 'financialConstructionRevenueNotice',
        key: 'no',
        type: 'area',
      },
      {
  ...
  },
  {
    ...
    conditions: [
      ...
      {
        value: 44,
        text: 'Giá trị của từng hợp đồng phải đảm bảo lớn hơn',
        field: 'contractMinValue',
        key: 'no',
        type: 'option',
      },
      {
        value: 45,
        text: 'Tổng giá trị của tất cả các hợp đồng phải lớn hơn',
        field: 'contractMinTotalValue',
        key: 'no',
        type: 'option',
      },
      ...
      },
      {
        value: 411,
        text: 'Tổng giá trị của tất cả các hợp đồng phải lớn hơn',
        field: 'contractMinTotalValueNotice',
        key: 'no',
        type: 'area',
      },
      {
  ...
  { value: 8, text: 'Điều khoản hợp đồng', key: 'no', conditions: [] },
  {
    ...
    conditions: [
      ...
      {
        value: 95,
        text: 'Thỏa thuận liên danh (nếu có)',
        field: 'key',
        key: 'no',
        type: 'text',
      },
...
exports.BIIDING_TERM = [
  ...
  {
    value: 5,
    text: 'Nguồn lực tài chính hàng tháng cho các hợp đồng đang thực hiện',
    key: 'no',
  },
  ...
  {
    value: 8,
    text: 'Bản lý lịch chuyên môn của nhân sự chủ chốt',
    key: 'no',
  },
...
exports.PCM_STATUS_TASK = [
  ...
  },
  {
    value: 4,
    text: 'Treo lại',
    class: 'tajic-status-btn-deferred',
    backgroud: '8f1aac',
    key: 'deferred',
  },
  {
    ...
    class: 'tajic-status-btn-waiting',
    backgroud: '4d4dff',
...
exports.ADREPORT_TYPES = [
  ...
  },
  {
    ...
    accounts: ['128', '131', '136', '138', '141'],
    isDebit: true,
  },
  {
    value: 5,
    text: 'Công nợ phải trả',
    accounts: ['331', '334', '336', '338', '341'],
    isDebit: false,
  },
]
