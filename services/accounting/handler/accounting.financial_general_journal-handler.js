...
const FINANCIAL_GENERAL_JOURNAL_MODEL =
    require('../model/accounting.financial_general_journal-model').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.insert({})
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.update({})
                return renderStatusCodeAndResponse({
                    resultAfterCallHandler,
                    ctx,
                })
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.remove({})
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (journalID) {
                    resultAfterCallHandler =
                        await FINANCIAL_GENERAL_JOURNAL_MODEL.getInfo({
                            journalID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await FINANCIAL_GENERAL_JOURNAL_MODEL.getList({
                            option,
                            forward,
                            cancel,
                            companyID,
    ...
    calImpleBudget: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.calImpleBudget({
                        workID,
                        groupID,
                        itemID,
                        budgetID,
    ...
    getAccountBalance: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.getAccountBalance({
                        userID,
                        ctx,
                        companyID,
                        fundaID,
    ...
    analysePrimeCostOfAllVouchers: {
        ...
        async handler(ctx) {
            try {
                ...
                let { companyID, fundaID, accountID, fromDate, toDate } =
                    ctx.params
                ...
                const resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.analysePrimeCostOfAllVouchers(
                        {
                            companyID,
                            fundaID,
                            accountID,
    ...
    exportExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await FINANCIAL_GENERAL_JOURNAL_MODEL.exportExcelByFilter({
                        userID,
                        companyID,
                        filterParams,
                        type,
