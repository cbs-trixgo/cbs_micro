const { EVENT_SOCKET_CONSTANT_ACCOUNTING } 		= require('./helper/accounting.events-socket-constant');
...
exports.ACCOUNTING_SOCKET = {
	 ...
	 * Date: 08/01/2024
	 */
    [EVENT_SOCKET_CONSTANT_ACCOUNTING.ACCOUNTING_CSS_STATUS_UPDATE_COST_ANALYSIS]: function(data) {
        let socket                      = this;
		...
		sendDataToMultilSocketsOfListUser({
			...
			data,
            event: [EVENT_SOCKET_CONSTANT_ACCOUNTING.ACCOUNTING_SSC_STATUS_UPDATE_COST_ANALYSIS], io
		});
    },
}