...
module.exports = {
	...
	*/
	actions: {
		// ==================== FRIEND REQUEST ========================
		[CF_ACTIONS_PERSONAL.FRIEND_REQUEST_GET_CODE] 	: FRIEND_REQUEST_HANDLER.getCode,
		[CF_ACTIONS_PERSONAL.FRIEND_REQUEST_CHECK_CODE] : FRIEND_REQUEST_HANDLER.checkCodeFriendRequest,
	
		// ==================== NOTE ========================
		[CF_ACTIONS_PERSONAL.NOTE_INSERT] 				: NOTE_HANDLER.insert,
		[CF_ACTIONS_PERSONAL.NOTE_UPDATE] 				: NOTE_HANDLER.update,
		[CF_ACTIONS_PERSONAL.NOTE_GET_INFO_AND_GET_LIST]: NOTE_HANDLER.getInfoAndGetList,
	},
