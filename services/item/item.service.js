...
module.exports = {
	...
	*/
	actions: {
		...
		[CF_ACTIONS_ITEM.DEPARTMENT_UPDATE_VALUE]				: ITEM__DEPARTMENT_HANDLER.updateValue,
		[CF_ACTIONS_ITEM.DEPARTMENT_GET_LIST] 					: ITEM__DEPARTMENT_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_ITEM.DEPARTMENT_GET_LIST_IS_MEMBERS] 		: ITEM__DEPARTMENT_HANDLER.getListByMembers,
		[CF_ACTIONS_ITEM.DEPARTMENT_ANALYSIS_ONTIME_ON_BUDGET] 	: ITEM__DEPARTMENT_HANDLER.analysisOntimeOnbudget,
		...
		[CF_ACTIONS_ITEM.CONTRACT_GET_INFO_AND_GET_LIST] 		: ITEM__CONTRACT_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_ITEM.CONTRACT_GET_LIST_GUARANTEE] 			: ITEM__CONTRACT_HANDLER.getListGuarantee,
		[CF_ACTIONS_ITEM.CONTRACT_GET_LIST_CONTRACT_IS_MEMBERS]	: ITEM__CONTRACT_HANDLER.getListIsMembers,
		[CF_ACTIONS_ITEM.CONTRACT_GET_LIST_BY_FILTER]			: ITEM__CONTRACT_HANDLER.getListByFilter,
		[CF_ACTIONS_ITEM.CONTRACT_GET_AMOUNT_BY_MONTH]			: ITEM__CONTRACT_HANDLER.getAmountByMonth,
		[CF_ACTIONS_ITEM.CONTRACT_GET_LIST_BY_MONTH]			: ITEM__CONTRACT_HANDLER.getListByMonth,
		[CF_ACTIONS_ITEM.CONTRACT_GET_AMOUNT_BY_PROPERTY]		: ITEM__CONTRACT_HANDLER.getAmountByProperty,
		[CF_ACTIONS_ITEM.CONTRACT_GET_RETAIN_PRODUCE]			: ITEM__CONTRACT_HANDLER.getRetainProduce,
		[CF_ACTIONS_ITEM.CONTRACT_GET_INVENTORY]				: ITEM__CONTRACT_HANDLER.getInventory,
		[CF_ACTIONS_ITEM.CONTRACT_STATISTICAL_STATUS_BY_ONTIME_ON_BUDGET]: ITEM__CONTRACT_HANDLER.statisticalStatusByOntimeOnbudget,
		[CF_ACTIONS_ITEM.CONTRACT_IMPORT_FROM_EXCEL]			: ITEM__CONTRACT_HANDLER.importFromExcel,
		...
		[CF_ACTIONS_ITEM.DOCTYPE_GET_INFO_AND_GET_LIST] 		: ITEM__DOCTYPE_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_ITEM.DOCTYPE_IMPORT_FROM_EXCEL]				: ITEM__DOCTYPE_HANDLER.importFromExcel,

		//==========================================  CONTACT  ===================================
		[CF_ACTIONS_ITEM.CONTACT_INSERT] 						: ITEM__CONTACT_HANDLER.insert,
		[CF_ACTIONS_ITEM.CONTACT_UPDATE] 						: ITEM__CONTACT_HANDLER.update,
		[CF_ACTIONS_ITEM.CONTACT_GET_INFO_AND_GET_LIST] 		: ITEM__CONTACT_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_ITEM.CONTACT_GET_LIST_BY_FILTER] 			: ITEM__CONTACT_HANDLER.getListByFilter,
		[CF_ACTIONS_ITEM.CONTACT_GET_LIST_BY_PROPERTY] 			: ITEM__CONTACT_HANDLER.getListByProperty,
		[CF_ACTIONS_ITEM.CONTACT_GET_LIST_OF_SYSTEM] 			: ITEM__CONTACT_HANDLER.getListOfSystem,
		[CF_ACTIONS_ITEM.CONTACT_GET_LIST_ACCESS_BY_CONTRACT] 	: ITEM__CONTACT_HANDLER.getListAccessByContract,
		[CF_ACTIONS_ITEM.CONTACT_DOWNLOAD_TEMPLATE_IMPORT_EXCEL]: ITEM__CONTACT_HANDLER.downloadTemplateImportExcel,
		[CF_ACTIONS_ITEM.CONTACT_IMPORT_FROM_EXCEL]				: ITEM__CONTACT_HANDLER.importFromExcel,
		[CF_ACTIONS_ITEM.CONTACT_EXPORT_EXCEL] 					: ITEM__CONTACT_HANDLER.exportExcel,
		[CF_ACTIONS_ITEM.CONTACT_EXPORT_EXCEL_BY_FILTER] 		: ITEM__CONTACT_HANDLER.exportExcelByFilter,
		...
		[CF_ACTIONS_ITEM.WAREHOUSE_GET_INFO_AND_GET_LIST] 		: ITEM__WAREHOUSE_HANDLER.getInfoAndGetList,

		//==========================================  AREA  ======================================
		[CF_ACTIONS_ITEM.AREA_INSERT] 							: ITEM__AREA_HANDLER.insert,
		[CF_ACTIONS_ITEM.AREA_UPDATE] 							: ITEM__AREA_HANDLER.update,
		[CF_ACTIONS_ITEM.AREA_GET_INFO_AND_GET_LIST] 		    : ITEM__AREA_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_ITEM.POSITION_GET_INFO_AND_GET_LIST] 		: ITEM__POSITION_HANDLER.getInfoAndGetList,

		//==========================================  STORAGE  ===================================
		[CF_ACTIONS_ITEM.STORAGE_INSERT] 						: ITEM__STORAGE_HANDLER.insert,
		[CF_ACTIONS_ITEM.STORAGE_UPDATE] 						: ITEM__STORAGE_HANDLER.update,
		[CF_ACTIONS_ITEM.STORAGE_GET_INFO_AND_GET_LIST] 		: ITEM__STORAGE_HANDLER.getInfoAndGetList,

		//==========================================  ACCOUNT  ===================================
		[CF_ACTIONS_ITEM.ACCOUNT_INSERT] 						: ITEM__ACCOUNT_HANDLER.insert,
		[CF_ACTIONS_ITEM.ACCOUNT_UPDATE] 						: ITEM__ACCOUNT_HANDLER.update,
		[CF_ACTIONS_ITEM.ACCOUNT_GET_INFO_AND_GET_LIST] 		: ITEM__ACCOUNT_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_ITEM.ACCOUNT_GET_INFO_WITH_NAME] 			: ITEM__ACCOUNT_HANDLER.getInfoAccountWithName,
		[CF_ACTIONS_ITEM.ACCOUNT_GET_INFO_WITH_ID] 				: ITEM__ACCOUNT_HANDLER.getInfoAccount,
		[CF_ACTIONS_ITEM.ACCOUNT_GET_LIST_NESTED] 				: ITEM__ACCOUNT_HANDLER.getListNestedItem,
		[CF_ACTIONS_ITEM.ACCOUNT_SEARCH_WITH_KEY] 				: ITEM__ACCOUNT_HANDLER.getListWithKey,

		//==========================================  FUNDA  ================================
		[CF_ACTIONS_ITEM.FUNDA_INSERT] 							: ITEM__FUNDA_HANDLER.insert,
		[CF_ACTIONS_ITEM.FUNDA_UPDATE] 							: ITEM__FUNDA_HANDLER.update,
		[CF_ACTIONS_ITEM.FUNDA_GET_INFO_AND_GET_LIST] 			: ITEM__FUNDA_HANDLER.getInfoAndGetList,

		//==========================================  GOOD  ======================================
		[CF_ACTIONS_ITEM.GOOD_INSERT] 							: ITEM__GOOD_HANDLER.insert,
		[CF_ACTIONS_ITEM.GOOD_UPDATE] 							: ITEM__GOOD_HANDLER.update,
		[CF_ACTIONS_ITEM.GOOD_GET_INFO_AND_GET_LIST] 			: ITEM__GOOD_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_ITEM.GOOD_DOWNLOAD_TEMPLATE_EXCEL]	: ITEM__GOOD_HANDLER.downloadTemplateExcel,
		[CF_ACTIONS_ITEM.GOOD_IMPORT_FROM_EXCEL]				: ITEM__GOOD_HANDLER.importFromExcel,
		...
		[CF_ACTIONS_ITEM.SIGNATURE_GET_INFO_AND_GET_LIST]		: ITEM__SIGNATURE_HANDLER.getInfoAndGetList,

		//==========================================  DEPARTMENT DIRECTORY  ======================================
		[CF_ACTIONS_ITEM.DEPARTMENT_DIRECTORY_INSERT] 				: ITEM__DEPARTMENT_DIRECTORY_HANDLER.insert,
		[CF_ACTIONS_ITEM.DEPARTMENT_DIRECTORY_UPDATE] 				: ITEM__DEPARTMENT_DIRECTORY_HANDLER.update,
		[CF_ACTIONS_ITEM.DEPARTMENT_DIRECTORY_GET_INFO_AND_GET_LIST]: ITEM__DEPARTMENT_DIRECTORY_HANDLER.getInfoAndGetList,

		//==========================================  CONFIG  ======================================
		[CF_ACTIONS_ITEM.CONFIG_INSERT] 							: ITEM__CONFIG_HANDLER.insert,
		[CF_ACTIONS_ITEM.CONFIG_UPDATE] 							: ITEM__CONFIG_HANDLER.update,
		[CF_ACTIONS_ITEM.CONFIG_GET_INFO_AND_GET_LIST] 		    	: ITEM__CONFIG_HANDLER.getInfoAndGetList,
	},
