...
module.exports = {
    ...
    insert: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await ITEM__AREA_MODEL.insert({
                    parentID,
                    name,
                    sign,
                    userID,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await ITEM__AREA_MODEL.update({
                    areaID,
                    name,
                    sign,
                    userID,
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                await this.validateEntity(ctx.params)
                let { areaID, keyword, limit, lastestID, select, populates } =
                    ctx.params
