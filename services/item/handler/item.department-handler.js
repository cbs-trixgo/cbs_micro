        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await ITEM__DEPARTMENT_MODEL.insert({
                        ctx,
                        authorID: userID,
                        company: companyID,
                        type,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await ITEM__DEPARTMENT_MODEL.update({
                        departmentID,
                        type,
                        name,
                        admins,
    ...
    updateValue: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await ITEM__DEPARTMENT_MODEL.updateValue({
                        option,
                        projectID,
                        userID,
                        ctx,
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (departmentID) {
                    resultAfterCallHandler =
                        await ITEM__DEPARTMENT_MODEL.getInfo({
                            departmentID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await ITEM__DEPARTMENT_MODEL.getList({
                            companyID,
                            lastestID,
                            userID,
                            type,
    ...
    getListByMembers: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await ITEM__DEPARTMENT_MODEL.getListByMembers({
                        option,
                        companyID,
                        lastestID,
                        userID,
    ...
    analysisOntimeOnbudget: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await ITEM__DEPARTMENT_MODEL.analysisOntimeOnbudget({
                        userID,
                    })
                return renderStatusCodeAndResponse({
                    resultAfterCallHandler,
