...
module.exports = {
  ...
  mixins: [DbService('files'), CacheCleaner([CF_DOMAIN_SERVICES.FILE])],
  ...
  actions: {
    ...
    [CF_ACTIONS_FILE.GET_LIST_FILE_OF_USER_WITH_STATUS]:
      FILE__CORE_HANDLER.getListFileWithStatus,
    [CF_ACTIONS_FILE.GENERATE_LINK_S3]: FILE__CORE_HANDLER.generateLinkS3,
    [CF_ACTIONS_FILE.DOWNLOAD_FILE_BY_URL]:
      FILE__CORE_HANDLER.downloadFileByURL,
  },
