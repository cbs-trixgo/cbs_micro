...
exports.vnp_HashSecret =
  process.env.PAYMENT__VNP_HASHSECRET || 'ODJLXOCEWMFIEJXHJNMZUVFFVRDDXLOT'
exports.vnp_Url =
  process.env.PAYMENT__VNP_URL ||
  'http://sandbox.vnpayment.vn/paymentv2/vpcpay.html'
exports.vnp_ReturnUrl =
  process.env.PAYMENT__VNP_RETURN_URL ||
