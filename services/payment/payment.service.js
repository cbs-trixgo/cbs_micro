...
module.exports = {
   ...
   */
  actions: {
    [CF_ACTIONS_PAYMENT.GET_LIST_TRANSACTION]:
      PAYMENT__TRANSACTION_HANLDER.getListTransactions,
    [CF_ACTIONS_PAYMENT.GET_LIST_TRANSACTION_BY_USER_WITH_STATUS]:
      PAYMENT__TRANSACTION_HANLDER.getListTransactionsByUserWithStatus,
    [CF_ACTIONS_PAYMENT.CREATE_URL_PAYMENT]:
      PAYMENT__TRANSACTION_HANLDER.createURLPayment,
    [CF_ACTIONS_PAYMENT.URL_RETURN_PAYMENT]:
      PAYMENT__TRANSACTION_HANLDER.URL_RETURN,
    [CF_ACTIONS_PAYMENT.UPDATE_STATUS]:
      PAYMENT__TRANSACTION_HANLDER.updateStatusTransaction,
  },
