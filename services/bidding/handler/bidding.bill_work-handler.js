        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await BIDDING__BILL_WORK_MODEL.insert({
                        userID,
                        ctx,
                        groupID,
                        datahubJobID,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await BIDDING__BILL_WORK_MODEL.update({
                        userID,
                        ctx,
                        workID,
                        datahubJobID,
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await BIDDING__BILL_WORK_MODEL.remove({
                        workID,
                        userID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (workID) {
                    resultAfterCallHandler =
                        await BIDDING__BILL_WORK_MODEL.getInfo({
                            workID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await BIDDING__BILL_WORK_MODEL.getList({
                            groupID,
                            keyword,
                            limit,
                            lastestID,
