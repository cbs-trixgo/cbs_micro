        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await BIDDING__QUOTATION_MODEL.insert({
                        companyID,
                        fundaID,
                        contractID,
                        projectID,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await BIDDING__QUOTATION_MODEL.update({
                        cashFlowID,
                        contractID,
                        name,
                        openingBalance,
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await BIDDING__QUOTATION_MODEL.remove({
                        cashFlowsID,
                        userID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (cashFlowID) {
                    resultAfterCallHandler =
                        await BIDDING__QUOTATION_MODEL.getInfo({
                            cashFlowID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await BIDDING__QUOTATION_MODEL.getList({
                            companyID,
                            projectID,
                            contractID,
                            parentID,
