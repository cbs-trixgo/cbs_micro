    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await BIDDING__BILL_PRODUCT_MODEL.update({
                        userID,
                        ctx,
                        docProductID,
                        note,
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await BIDDING__BILL_PRODUCT_MODEL.remove({
                        docProductID,
                        userID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (docProductID) {
                    resultAfterCallHandler =
                        await BIDDING__BILL_PRODUCT_MODEL.getInfo({
                            docProductID,
                            userID,
                            select,
                            populates,
                    ...
                    resultAfterCallHandler =
                        await BIDDING__BILL_PRODUCT_MODEL.getList({
                            projectID,
                            docID,
                            userID,
                            keyword,
