        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await PCM_FILE_MODEL.getListFilesGroupByDate({
                        companyID,
                        projectID,
                        userID,
                        year,
    ...
    getListFilesGroupByContract: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await PCM_FILE_MODEL.getListFilesGroupByContract({
                        keyword,
                        projectID,
                        year,
                        userID,
    ...
    getListByFilter: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await PCM_FILE_MODEL.getListByFilter({
                        fromDate,
                        toDate,
                        authorsID,
                        companyOfAuthorsID,
    ...
    downloadFiles: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await PCM_FILE_MODEL.downloadFilesV2({
                        taskID,
                        userID,
                    })
    ...
    downloadFilesInGroup: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler =
                    await PCM_FILE_MODEL.downloadFilesInGroup({
                        groupID,
                        userID,
                    })
