 ...
 * MODELS
 */
const PCM_COMMENT_REACTION_MODEL            = require('../model/subject_pcm.pcm_comment_reaction-model').MODEL;
    ...
    reaction: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await PCM_COMMENT_REACTION_MODEL.reaction({
    ...
    getListReaction: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await PCM_COMMENT_REACTION_MODEL.getListReaction({
