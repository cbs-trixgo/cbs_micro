...
module.exports = {
	...
	*/
	actions: {	
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_CONTACT_GET_INFO_AND_GET_LIST]	: DATAHUB_CONTACT_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_TYPE_GET_INFO_AND_GET_LIST]	: DATAHUB_TYPE_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_PROJECT_GET_INFO_AND_GET_LIST]	: DATAHUB_PROJECT_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_DATAHUB.DATAHUB_PROJECT_DOWNLOAD_TEMPLATE_IMPORT_EXCEL]   : DATAHUB_PROJECT_HANDLER.downloadTemplateImportExcel,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_PACKAGE_GET_INFO_AND_GET_LIST]	: DATAHUB_PACKAGE_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_DATAHUB.DATAHUB_PACKAGE_GET_LIST_BY_PROPERTY]	: DATAHUB_PACKAGE_HANDLER.getListByProperty,

		//==========================================   DATAHUB FINREPORT   ================================
		[CF_ACTIONS_DATAHUB.DATAHUB_FINREPORT_INSERT]   			 	: DATAHUB_FINREPORT_HANDLER.insert,
		[CF_ACTIONS_DATAHUB.DATAHUB_FINREPORT_UPDATE]   			 	: DATAHUB_FINREPORT_HANDLER.update,
		[CF_ACTIONS_DATAHUB.DATAHUB_FINREPORT_REMOVE]					: DATAHUB_FINREPORT_HANDLER.remove,
		[CF_ACTIONS_DATAHUB.DATAHUB_FINREPORT_GET_INFO_AND_GET_LIST]	: DATAHUB_FINREPORT_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_DATAHUB.DATAHUB_FINREPORT_GET_LIST_BY_PROPERTY]		: DATAHUB_FINREPORT_HANDLER.getListByProperty,

		//==========================================   DATAHUB_MATERIAL   ================================
		[CF_ACTIONS_DATAHUB.DATAHUB_MATERIAL_INSERT]   			 	: DATAHUB_MATERIAL_HANDLER.insert,
		[CF_ACTIONS_DATAHUB.DATAHUB_MATERIAL_UPDATE]   			 	: DATAHUB_MATERIAL_HANDLER.update,
		[CF_ACTIONS_DATAHUB.DATAHUB_MATERIAL_REMOVE]					: DATAHUB_MATERIAL_HANDLER.remove,
		[CF_ACTIONS_DATAHUB.DATAHUB_MATERIAL_GET_INFO_AND_GET_LIST]	: DATAHUB_MATERIAL_HANDLER.getInfoAndGetList,

		//==========================================   DATAHUB CONTRACTOR   ================================
		[CF_ACTIONS_DATAHUB.DATAHUB_CONTRACTOR_INSERT]   			 	: DATAHUB_CONTRACTOR_HANDLER.insert,
		[CF_ACTIONS_DATAHUB.DATAHUB_CONTRACTOR_UPDATE]   			 	: DATAHUB_CONTRACTOR_HANDLER.update,
		[CF_ACTIONS_DATAHUB.DATAHUB_CONTRACTOR_REMOVE]					: DATAHUB_CONTRACTOR_HANDLER.remove,
		[CF_ACTIONS_DATAHUB.DATAHUB_CONTRACTOR_GET_INFO_AND_GET_LIST]	: DATAHUB_CONTRACTOR_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_PROFILE_GET_INFO_AND_GET_LIST]	: DATAHUB_PROFILE_HANDLER.getInfoAndGetList,

		//==========================================   DATAHUB INSPECTION DOC   ================================
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_DOC_INSERT]   				: DATAHUB_INSPECTION_DOC_HANDLER.insert,
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_DOC_UPDATE]   			 	: DATAHUB_INSPECTION_DOC_HANDLER.update,
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_DOC_REMOVE]					: DATAHUB_INSPECTION_DOC_HANDLER.remove,
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_DOC_GET_INFO_AND_GET_LIST]	: DATAHUB_INSPECTION_DOC_HANDLER.getInfoAndGetList,

		//==========================================   DATAHUB INSPECTION CHECKLIST   ================================
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_CHECKLIST_INSERT]   				: DATAHUB_INSPECTION_CHECKLIST_HANDLER.insert,
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_CHECKLIST_UPDATE]   			 	: DATAHUB_INSPECTION_CHECKLIST_HANDLER.update,
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_CHECKLIST_REMOVE]				: DATAHUB_INSPECTION_CHECKLIST_HANDLER.remove,
		[CF_ACTIONS_DATAHUB.DATAHUB_INSPECTION_CHECKLIST_GET_INFO_AND_GET_LIST]	: DATAHUB_INSPECTION_CHECKLIST_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_JOB_GET_INFO_AND_GET_LIST]	: DATAHUB_JOB_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_JOBLINE_GET_INFO_AND_GET_LIST]	: DATAHUB_JOBLINE_HANDLER.getInfoAndGetList,
		...
		[CF_ACTIONS_DATAHUB.DATAHUB_PRODUCT_GET_INFO_AND_GET_LIST]	: DATAHUB_PRODUCT_HANDLER.getInfoAndGetList,

		//==========================================   DATAHUB TEMPLATE   ================================
		[CF_ACTIONS_DATAHUB.DATAHUB_TEMPLATE_INSERT]   			 	: DATAHUB_TEMPLATE_HANDLER.insert,
		[CF_ACTIONS_DATAHUB.DATAHUB_TEMPLATE_UPDATE]   			 	: DATAHUB_TEMPLATE_HANDLER.update,
		[CF_ACTIONS_DATAHUB.DATAHUB_TEMPLATE_REMOVE]					: DATAHUB_TEMPLATE_HANDLER.remove,
		[CF_ACTIONS_DATAHUB.DATAHUB_TEMPLATE_GET_INFO_AND_GET_LIST]	: DATAHUB_TEMPLATE_HANDLER.getInfoAndGetList,
		[CF_ACTIONS_DATAHUB.DATAHUB_TEMPLATE_DOWNLOAD_TEMPLATE_IMPORT_EXCEL]   : DATAHUB_TEMPLATE_HANDLER.downloadTemplateImportExcel,
	},
