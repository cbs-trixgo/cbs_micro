 ...
 * MODELS
 */
const DATAHUB_MATERIAL_MODEL =
    require('../model/datahub.datahub_material-model').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_MATERIAL_MODEL.insert({
                        company,
                        name,
                        files,
                        userID,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_MATERIAL_MODEL.update({
                        datahubProfileID,
                        name,
                        files,
                        filesRemove,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_MATERIAL_MODEL.remove({
                        datahubProfileID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (datahubProfileID) {
                    resultAfterCallHandler =
                        await DATAHUB_MATERIAL_MODEL.getInfo({
                            datahubProfileID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await DATAHUB_MATERIAL_MODEL.getList({
                            contractorID,
                            userID,
                            lastestID,
                            keyword,
