 ...
 * MODELS
 */
const DATAHUB_TEMPLATE_MODEL                      = require('../model/datahub.datahub_template-model').MODEL;
    ...
    downloadTemplateImportExcel: {
        ...
        async handler(ctx) {
            try {
                ...
                const resultAfterCallHandler = await DATAHUB_TEMPLATE_MODEL.downloadTemplateImportExcel({
                    userID 
                })
