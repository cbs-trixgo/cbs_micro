        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_TEMPLATE_MODEL.insert({
                        name,
                        note,
                        type,
                        status,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_TEMPLATE_MODEL.update({
                        datahubProjectID,
                        client,
                        address,
                        area3,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_TEMPLATE_MODEL.remove({
                        datahubProjectID,
                    })
    ...
    getInfoAndGetList: {
        ...
        async handler(ctx) {
            try {
                ...
                if (datahubProjectID) {
                    resultAfterCallHandler =
                        await DATAHUB_TEMPLATE_MODEL.getInfo({
                            datahubProjectID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await DATAHUB_TEMPLATE_MODEL.getList({
                            userID,
                            lastestID,
                            keyword,
                            limit: +limit,
