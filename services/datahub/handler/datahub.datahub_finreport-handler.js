 ...
 * MODELS
 */
const DATAHUB_FINREPORT_MODEL =
    require('../model/datahub.datahub_finreport-model').MODEL
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_FINREPORT_MODEL.insert({
                        contractor,
                        fiscalYear,
                        asset,
                        liabilitiy,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_FINREPORT_MODEL.update({
                        datahubFinreportID,
                        fiscalYear,
                        asset,
                        liabilitiy,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_FINREPORT_MODEL.remove({
                        datahubFinreportID,
                    })
        ...
        async handler(ctx) {
            try {
                ...
                if (datahubFinreportID) {
                    resultAfterCallHandler =
                        await DATAHUB_FINREPORT_MODEL.getInfo({
                            datahubFinreportID,
                            select,
                            populates,
                        })
                    ...
                    resultAfterCallHandler =
                        await DATAHUB_FINREPORT_MODEL.getList({
                            contractorID,
                            userID,
                            lastestID,
                            keyword,
    ...
    getListByProperty: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await DATAHUB_FINREPORT_MODEL.getListByProperty({
                        option,
                        contractorID,
                    })
