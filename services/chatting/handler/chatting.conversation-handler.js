 ...
 * MODELS
 */
const CHATTING__CONVERSATION_MODEL =
  require('../model/chatting.conversation-model').MODEL
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.insertConversation({
            name,
            description,
            bizfullname,
            authorID,
  ...
  updateConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updateConversation({
            conversationID,
            userID,
            name,
            description,
  ...
  updateConversationNamePrivate: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updateConversationNamePrivate({
            userID,
            bizfullname,
          })
  ...
  addMembersToConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.addMembersToConversation({
            conversationID,
            authorID,
            membersID,
          })
  ...
  removeMemberInConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.removeMemberInConversation({
            conversationID,
            authorID,
            memberID,
          })
  ...
  updateAdminConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updateAdminConversation({
            conversationID,
            authorID,
            memberID,
            isSetAdmin,
  ...
  updateConfigConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updateConfigConversation({
            conversationID,
            authorID,
            typeConfig,
            valueConfig,
  ...
  updatePinConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updatePinConversation({
            conversationID,
            userID,
            isPin,
            ctx,
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getInfoConversationByID({
            conversationID,
            userID,
            filter,
            select,
  ...
  getInfoGeneralGroupsByMember: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getInfoGeneralGroupsByMember({
            userID,
            memberID,
          })
  ...
  getListMessagesConversationWithPage: {
    ...
    async handler(ctx) {
      try {
        await this.validateEntity(ctx.params)
        let { _id: userID } = ctx.meta.infoUser
        let { conversationID, lastestID, keyword, limit, filter, select } =
          ctx.params

        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getListMessagesConversationWithPage(
            {
              conversationID,
              lastestID,
              userID,
  ...
  searchMessageConversationById: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.searchMessageConversationById({
            conversationID,
            userID,
            messageID,
            filter,
  ...
  getListMessagesMediaConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getListMessagesMediaConversation({
            conversationID,
            userID,
            typeMessage,
            senderID,
  ...
  getListMemberSendMessagesMediaConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getListMemberSendMessagesMediaConversation(
            {
              conversationID,
              userID,
            }
  ...
  updateHideConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updateHideConversation({
            conversationID,
            userID,
            isHide,
          })
  ...
  updateMuteConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.updateMuteConversation({
            conversationID,
            userID,
            isMute,
            timeMute,
  ...
  markReadConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.markReadConversation({
            conversationID,
            userID,
          })
  ...
  memberLeaveConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.memberLeaveConversation({
            conversationID,
            userID,
          })
  ...
  deleteConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.deleteConversation({
            conversationID,
            userID,
          })
  ...
  deleteHistoryConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        let resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.deleteHistoryConversation({
            conversationID,
            userID,
          })
  ...
  getListConversationWithPage: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getListConversationWithPage({
            lastestID,
            userID,
            keyword,
            bizfullname,
  ...
  getListPinConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler = await ctx.call(
  ...
  getListConversationMissMessage: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_MODEL.getListConversationMissMessage({
            userID,
            lastestID,
            limit,
            filter,
  ...
  getListFileConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_FILE_MODEL.getList({
            userID,
            lastestID,
            conversationID,
            authorID,
  ...
  getListLinkConversation: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await CHATTING__CONVERSATION_LINK_MODEL.getList({
            userID,
            conversationID,
            messageID,
            authorID,
