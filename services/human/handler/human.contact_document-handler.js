        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await HUMAN__CONTACT_DOCUMENT_MODEL.insert({
                        userCreate: userID,
                        contactID,
                        type,
                        number,
    ...
    update: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await HUMAN__CONTACT_DOCUMENT_MODEL.update({
                        authorID: userID,
    ...
    remove: {
        ...
        async handler(ctx) {
            try {
                ...
                let resultAfterCallHandler =
                    await HUMAN__CONTACT_DOCUMENT_MODEL.remove({
                        contactDocumentID,
                        ctx,
                    })
        ...
        async handler(ctx) {
            try {
                ...
                if (contactDocumentID) {
                    resultAfterCallHandler =
                        await HUMAN__CONTACT_DOCUMENT_MODEL.getInfo({
                            contactDocumentID,
                            select,
                            populates,
                            ctx,
                    ...
                    resultAfterCallHandler =
                        await HUMAN__CONTACT_DOCUMENT_MODEL.getList({
                            companyID,
                            type,
                            contactID,
                            isDuration3Month,
