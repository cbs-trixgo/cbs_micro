...
module.exports = {
    ...
    actions: {
        ...
        [CF_ACTIONS_TRAINING.TRAINING__SUBJECT_INSERT]:
            TRAINING__SUBJECT_HANDLER.insert,
        [CF_ACTIONS_TRAINING.TRAINING__SUBJECT_UPDATE]:
            TRAINING__SUBJECT_HANDLER.update,
        [CF_ACTIONS_TRAINING.TRAINING__SUBJECT_REMOVE]:
            TRAINING__SUBJECT_HANDLER.remove,
        [CF_ACTIONS_TRAINING.TRAINING__SUBJECT_GET_INFO_AND_GET_LIST]:
            TRAINING__SUBJECT_HANDLER.getInfoAndGetList,

        //==========================================   TRAINING SUBJECT RATING ACTIONS   ================================
        [CF_ACTIONS_TRAINING.TRAINING__SUBJECT_RATING_INSERT]:
            TRAINING__SUBJECT_RATING_HANDLER.insert,
    },
