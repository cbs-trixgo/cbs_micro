        ...
        return new Promise(async (resolve) => {
            try {
                ...
                switch (infoMedia.type) {
                    case 1: {
                        ...
                        if (!listReceivers.error) {
                            arrReceiver = listReceivers.data?.map(
                                (user) => user._id
                            )
                        }
                        break
                ...
                arrReceiver = arrReceiver.filter(
                    (receiverID) =>
                        receiverID.toString() !== authorID.toString()
                )
    ...
    insert({
        ...
        return new Promise(async (resolve) => {
            try {
                ...
                if (infoAfterCreateNoti.error)
                    return resolve(infoAfterCreateNoti)
    ...
    update({ commentID, authorID, content, files, images, select, populates }) {
        return new Promise(async (resolve) => {
            try {
                ...
                let infoAfterUpdate =
                    await MEDIA__COMMENT_COLL.findOneAndUpdate(
                        {
                            _id: commentID,
                            author: authorID,
                        },
            ...
            try {
                ...
                if (!infoComment) {
                    return resolve({
                        ...
                        keyError:
                            'comment_not_exists_or_you_are_not_author_of_comment',
                        status: 400,
                    })
                }
                ...
                if (infoComment.parent) {
                    ...
                    await MEDIA__COMMENT_COLL.findByIdAndUpdate(
                        infoComment.parent,
                        {
                            $inc: {
                                amountCommentReply: -1,
    ...
    getList({
        ...
        return new Promise(async (resolve) => {
            try {
                ...
                let infoDataAfterGet = await MEDIA__COMMENT_COLL.find(
                    conditionObj
                )
                    .limit(limit + 1)
                    .sort(sortBy)
                ...
                let totalRecord =
                    await MEDIA__COMMENT_COLL.count(conditionObjOrg)
    ...
    insertCommentFile({
        ...
        return new Promise(async (resolve) => {
            try {
                ...
                let infoAfterInsert =
                    await MEDIA__COMMENT_FILE_COLL.create(dataInsert)
                if (!infoAfterInsert) {
                    return resolve({
                        error: true,
                        message:
    ...
    updateCommentFile({
        ...
        return new Promise(async (resolve) => {
            try {
                ...
                let infoAfterUpdate =
                    await MEDIA__COMMENT_FILE_COLL.findOneAndUpdate(
                        {
                            _id: commentID,
                            author: authorID,
                        },
                ...
                infoAfterUpdate = await MEDIA__COMMENT_FILE_COLL.findById(
                    commentID
                )
                    .select(select)
                    .populate(populates)
        ...
        return new Promise(async (resolve) => {
            try {
                ...
                if (infoComment.parent) {
                    ...
                    await MEDIA__COMMENT_FILE_COLL.findByIdAndUpdate(
                        infoComment.parent,
                        {
                            $inc: {
                                amountCommentReply: -1,
    ...
    getInfoCommentFile({ commentID, select, populates }) {
        return new Promise(async (resolve) => {
            try {
                ...
                let infoComment = await MEDIA__COMMENT_FILE_COLL.findById(
                    commentID
                )
                    .select(select)
                    .populate(populates)
    ...
    getListCommentFile({
        ...
        return new Promise(async (resolve) => {
            try {
                ...
                if (lastestID && checkObjectIDs(lastestID)) {
                    let infoData =
                        await MEDIA__COMMENT_FILE_COLL.findById(lastestID)
                    if (!infoData)
                        return resolve({
                            error: true,
                            message: "Can't get info lastestID",
                ...
                let infoDataAfterGet = await MEDIA__COMMENT_FILE_COLL.find(
                    conditionObj
                )
                    .limit(limit + 1)
                    .sort(sortBy)
                ...
                let totalRecord =
                    await MEDIA__COMMENT_FILE_COLL.count(conditionObjOrg)
                let dataResponse = await this.responseDataComment({
                    authorID,
                    comments: infoDataAfterGet,
                })
