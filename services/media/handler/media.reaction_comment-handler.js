 ...
 * MODELS
 */
const MEDIA__REACTION_COMMENT_MODEL =
  require('../model/media.reaction_comment-model').MODEL
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await MEDIA__REACTION_COMMENT_MODEL.reactionCommentMedia({
            authorID,
            commentID,
            typeReaction,
          })
  ...
  reactionCommentFile: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await MEDIA__REACTION_COMMENT_MODEL.reactionCommentFile({
            authorID,
            commentID,
            typeReaction,
          })
  ...
  getListReactionComment: {
    ...
    async handler(ctx) {
      try {
        ...
        const resultAfterCallHandler =
          await MEDIA__REACTION_COMMENT_MODEL.getListReactionComment({
            authorID,
            commentID,
            type,
            lastestID,
