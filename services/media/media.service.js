...
module.exports = {
    ...
    actions: {
        ...
        // ================================  MEDIA FILE  ================================
        [CF_ACTIONS_MEDIA.GET_INFO_AND_GET_LIST_MEMDIA_FILE]:
            MEDIA__FILE_HANDLER.getInfoAndGetListMediaFile,
        ...
        [CF_ACTIONS_MEDIA.GET_INFO_AND_GET_LIST_COMMENT_MEDIA]:
            MEDIA__COMMENT_HANDLER.getInfoAndGetList,

        [CF_ACTIONS_MEDIA.INSERT_COMMENT_FILE]:
            MEDIA__COMMENT_HANDLER.insertCommentFile,
        [CF_ACTIONS_MEDIA.UPDATE_COMMENT_FILE]:
            MEDIA__COMMENT_HANDLER.updateCommentFile,
        [CF_ACTIONS_MEDIA.DELETE_COMMENT_FILE]:
            MEDIA__COMMENT_HANDLER.deleteCommentFile,
        [CF_ACTIONS_MEDIA.GET_INFO_AND_GET_LIST_COMMENT_FILE]:
            MEDIA__COMMENT_HANDLER.getInfoAndGetListCommentFile,

        // ================================  MEDIA REACTION  ================================

        [CF_ACTIONS_MEDIA.REACTION_MEDIA]: MEDIA__REACTION_HANDLER.reaction,
        [CF_ACTIONS_MEDIA.GET_LIST_REACTION_MEDIA]:
            MEDIA__REACTION_HANDLER.getListReaction,

        [CF_ACTIONS_MEDIA.REACTION_FILE]: MEDIA__REACTION_HANDLER.reactionFile,
        [CF_ACTIONS_MEDIA.GET_LIST_REACTION_FILE]:
            MEDIA__REACTION_HANDLER.getListReactionFile,

        [CF_ACTIONS_MEDIA.REACTION_COMMENT_MEDIA]:
            MEDIA__REACTION_COMMENT_HANDLER.reactionCommentMedia,
        [CF_ACTIONS_MEDIA.REACTION_COMMENT_FILE]:
            MEDIA__REACTION_COMMENT_HANDLER.reactionCommentFile,
        [CF_ACTIONS_MEDIA.GET_LIST_REACTION_COMMENT]:
            MEDIA__REACTION_COMMENT_HANDLER.getListReactionComment,
    },
